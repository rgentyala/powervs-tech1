resource "ibm_pi_ike_policy" "ikepol6" {    
...
resource "ibm_pi_ipsec_policy" "ipsecpol6" {
  pi_cloud_instance_id    = "42175bd4-dc42-4ce0-ac6f-bc55caac4b7c"
...
resource "ibm_pi_vpn_connection" "vpndfd2" {
  ...
  pi_ike_policy_id        = ibm_pi_ike_policy.policy.ikepol6
  pi_ipsec_policy_id      = ibm_pi_ipsec_policy.policy.ipsecpol6
